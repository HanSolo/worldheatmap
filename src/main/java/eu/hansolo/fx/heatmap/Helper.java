...
public class Helper {
    ...
    public static double getSignedDegrees(final int DEGREES, final int MINUTES, final int SECONDS) { return DEGREES + (MINUTES / 60.0) + (SECONDS / 3600.0); }
    public static double getSignedDegrees(final int DEGREES, final double MINUTES) { return DEGREES + (MINUTES / 60.0); }
    ...
    public static String getLatitudeDirection(final double LATITUDE) { return LATITUDE > 0 ? "N" : "S"; }
    public static String getLongitudeDirection(final double LONGITUDE) { return LONGITUDE > 0 ? "E" : "W"; }
